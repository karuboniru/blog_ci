...
如果你只希望 per user 的配置而非类似于 fcitx5-autostart 那样针对所有用户，那么可以参见 #link("/2020/08/30/")[前文]，不过相应的把 `/usr/share/applications/fcitx5.desktop` 换成 `/usr/share/applications/org.fcitx.Fcitx5.desktop` 即可。
